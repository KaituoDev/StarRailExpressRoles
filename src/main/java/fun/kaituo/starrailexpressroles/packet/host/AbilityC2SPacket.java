package fun.kaituo.starrailexpressroles.packet.host;
...
public record AbilityC2SPacket() implements CustomPayload {
    ...
    public static final Identifier ABILITY_PAYLOAD_ID = Identifier.of(StarRailExpressRoles.MOD_ID, "ability");
